...
export function ActionsMenu({ code, hasJobs, jobCount, onRescanStart }: ActionsMenuProps) {
    ...
    <>
      ...
      {rescanOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-black/40 backdrop-blur-sm" onClick={handleRescanClose} />
          <div className="relative w-full max-w-lg rounded-2xl border border-slate-200 bg-white p-6 shadow-2xl animate-slide-up">
            <h3 className="font-display text-lg font-bold text-primary-950">Re-run Scraper</h3>
            ...
            <p className="mt-3 text-xs text-slate-400">
              The scraper uses your saved session preferences (keywords, location, sources). New jobs will appear on the dashboard automatically.
            </p>
