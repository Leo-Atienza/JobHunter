...
export const JOB_SOURCES = ['linkedin', 'linkedin-public', 'indeed', 'glassdoor', 'rapidapi', 'jobbank', 'remotive', 'adzuna', 'himalayas', 'themuse', 'arbeitnow', 'lever', 'greenhouse', 'workday', 'jooble', 'jobicy', 'devitjobs', 'careerjet', 'usajobs'] as const;
